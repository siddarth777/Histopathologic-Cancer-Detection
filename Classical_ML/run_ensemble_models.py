...
parser.add_argument("--train_path", default="/data-saturn/AudioBench/prml/prml_data/feature_eng_data/full96_train.csv")
parser.add_argument("--test_path", default="/data-saturn/AudioBench/prml/prml_data/feature_eng_data/full96_test.csv")
